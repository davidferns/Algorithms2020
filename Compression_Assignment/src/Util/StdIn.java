package Util; /******************************************************************************
 *  Compilation:  javac practical1.StdIn.java
 *  Execution:    java practical1.StdIn   (interactive test of basic functionality)
 *  Dependencies: none
 *
...
/**
 *  The {@code practical1.StdIn} class provides static methods for reading strings
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code practical1.StdIn.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdIn.java">practical1.StdIn.java</a>
 ...
 *  <pre>
 *  while (!practical1.StdIn.isEmpty()) {
 *      double value = practical1.StdIn.readDouble();
 *      practical1.StdOut.println(value);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (practical1.StdIn.hasNextChar()) {
 *      char c = practical1.StdIn.readChar();
 *      practical1.StdOut.print(c);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (practical1.StdIn.hasNextLine()) {
 *      String line = practical1.StdIn.readLine();
 *      practical1.StdOut.println(line);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  String[] words = practical1.StdIn.readAllStrings();
 *  </pre>
 *  <p>
 *  <b>Differences with Scanner.</b>
 *  {@code practical1.StdIn} and {@link Scanner} are both designed to parse
 *  tokens and convert them to primitive types and strings.
 *  The main differences are summarized below:
 *  <ul>
 *  <li> {@code practical1.StdIn} is a set of static methods and reads
 ...
 *       and sockets.
 *  <li> {@code practical1.StdIn} uses whitespace as the delimiter pattern
 *       that separates tokens.
 *       {@link Scanner} supports arbitrary delimiter patterns.
 *  <li> {@code practical1.StdIn} coerces the character-set encoding to UTF-8,
 *       which is the most widely used character encoding for Unicode.
 *  <li> {@code practical1.StdIn} coerces the locale to {@link Locale#US},
 *       for consistency with {@link }, {@link Double#parseDouble(String)},
 *       and floating-point literals.
 *  <li> {@code practical1.StdIn} has convenient methods for reading a single
 *       character; reading in sequences of integers, doubles, or strings;
 *       and reading in all of the remaining input.
 *  </ul>
 *  <p>
 *  Historical note: {@code practical1.StdIn} preceded {@code Scanner}; when
 ...
 *  Windows, and Linux.
 *  The methods in {@code practical1.StdIn} are <em>blocking</em>, which means that they
 ...
 *  If the input begins with the optional byte-order mask, {@code practical1.StdIn}
...
public final class StdIn {
    ...
    /*** begin: section (1 of 2) of code duplicated from In to practical1.StdIn. */
    ...
    /*** end: section (1 of 2) of code duplicated from In to practical1.StdIn. */
    ...
    //// begin: section (2 of 2) of code duplicated from In to practical1.StdIn,
   ...
   /**
    ...
    //// end: section (2 of 2) of code duplicated from In to practical1.StdIn
    
    
    // do this once when practical1.StdIn is initialized
    static {
        resync();
    }

    /**
     * If practical1.StdIn changes, use this to reinitialize the scanner.
     */
